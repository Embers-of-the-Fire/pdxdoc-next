...
| [inline_scripts](dynamic_modding/inline_scripts.md)          | 内联脚本，将会单独开一个章节介绍                             |
...
| [scripted_effects](dynamic_modding/scripted_effect.md) | 封装触发的效果，一般用于事件效果（帝国生成/小灰转化等）      |
| [scripted_loc](dynamic_modding/scripted_localization.md)                                                 | 封装触发的文本，用于经常被引用的文本生成                     |
| [scripted_triggers](dynamic_modding/scripted_triggers.md) | 封装条件判断，用于经常被引用的事件判断                       |
| [scripted_variables](event_modding/further.md#脚本变量scripted-variables) | 常量，用于经常被引用的数值（科技数值等）                     |
| [script_values](dynamic_modding/script_values.md)                | 脚本值，用于复杂变量操作                                     |
